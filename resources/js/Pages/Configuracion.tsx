  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Personaliza tu experiencia en ProActiva</p>
      </div>

      <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
        <Card>
          <CardHeader className="p-4">
            <CardTitle className="flex items-center gap-2 text-lg sm:text-xl">Apariencia</CardTitle>
        ...
        <Card className="md:col-span-2">
          <CardHeader className="p-4">
            ...
            <CardDescription>Configura recordatorios para tus tareas</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 p-4 pt-0">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div className="space-y-0.5">
                <Label htmlFor="daily-reminder">Recordatorio diario</Label>
                <p className="text-sm text-muted-foreground">Recibe un resumen diario de tus tareas pendientes</p>
              </div>
